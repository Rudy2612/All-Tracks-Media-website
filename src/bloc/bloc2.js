            ...
            <>
                ...
                <div className="flex-bloc">
                    <div className="w-50-bloc">
                        <h5 className="title-bloc-img" style={{ textAlign: "right", marginRight: "20px" }}>{this.state.titre}</h5>
                    </div>
                    <div className="w-50-bloc">
                        <img className="img-bloc-50" src={this.state.photo}  onClick={this.imgPOP} id={this.state.photo}></img>
                    </div>
                </div>
            </>
        )
